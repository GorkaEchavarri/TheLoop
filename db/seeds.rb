...
comment1 = Comment.create!(content: "Can't believe I've been working on all these controllers while Gorka's been fishing for compliments online smh. Good guy though - great presenter", user_id: user11.id, post_id: post6.id )
comment1.save!
